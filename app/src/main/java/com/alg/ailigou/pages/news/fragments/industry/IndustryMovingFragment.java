...
public class IndustryMovingFragment extends BaseMvpFragment implements IndustryMovingContrats.View {
    @Inject
    IndustryMovingPresenter mPresenter;
    ...
    @Override
    protected IndustryMovingPresenter getPresenter() {
        return mPresenter;
    }
