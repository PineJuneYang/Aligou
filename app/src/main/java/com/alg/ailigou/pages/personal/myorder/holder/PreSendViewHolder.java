...
public class PreSendViewHolder extends MyBaseViewHolder {
    ...
    public PreSendViewHolder(View itemView, OnItemClickListener listener, OnClickListener onClickListener, int position, Context context) {
