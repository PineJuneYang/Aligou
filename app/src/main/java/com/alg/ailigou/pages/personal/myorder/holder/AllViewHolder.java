...
public class AllViewHolder extends MyBaseViewHolder {
    ...
    public AllViewHolder(View itemView, OnItemClickListener listener, OnClickListener onClickListener, int position, Context context) {
