...
public class PreReceiveViewHolder extends MyBaseViewHolder {
    ...
    public PreReceiveViewHolder(View itemView, OnItemClickListener listener, OnClickListener onClickListener, int position, Context context) {
...
//        mClickListener.setOnClickListener(view,getAdapterPosition());
        switch (view.getId()){
            case R.id.tv_item_my_order_view_logistics:
                mContext.startActivity(new Intent(mContext, SeeLogisticsActivity.class));
                break;
