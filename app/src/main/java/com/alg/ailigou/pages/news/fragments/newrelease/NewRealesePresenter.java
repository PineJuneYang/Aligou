...
public class NewRealesePresenter implements NewRealeseContrats.Presenter {
    private NewRealeseContrats.View view;

    @Inject
    public NewRealesePresenter() {
    }

    @Override
    public void bindView(NewRealeseContrats.View view) {
        this.view = view;
    }
