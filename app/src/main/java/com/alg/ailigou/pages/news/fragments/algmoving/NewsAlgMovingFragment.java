...
public class NewsAlgMovingFragment extends BaseMvpFragment implements NewsAlgMovingContrats.View {
    @Inject
    NewsAlgMovingPresenter mPresenter;
    ...
    @Override
    protected NewsAlgMovingPresenter getPresenter() {
        return mPresenter;
    }
