...
public class PrePaymentViewHolder extends MyBaseViewHolder {
    ...
    public PrePaymentViewHolder(View itemView, OnItemClickListener listener, OnClickListener onClickListener, int position, Context context) {
