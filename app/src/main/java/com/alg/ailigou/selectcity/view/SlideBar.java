package com.alg.ailigou.selectcity.view;
...
public class SlideBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < b.length; i++) {
            paint.setTextSize(getResources().getDimension(R.dimen.alg_city_side_letter_bar_letter_size));
            paint.setColor(getResources().getColor(R.color.alg_city_48));
            paint.setAntiAlias(true);
            if (i == choose) {
                paint.setColor(getResources().getColor(R.color.alg_city_gray_deep));
